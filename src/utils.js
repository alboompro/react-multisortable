...
/**
 * Altera o nome exibido para o componente no inspetor
 *
 * @param prefix
 * @param Component
 * @returns {string}
 */
export const provideDisplayName = (prefix, Component) => {
 ...
 * @return {Object}
 */
export const getBoundsForNode = (node, containerScroll = { scrollTop: 0, scrollLeft: 0 }) => {
 ...
 * @return {bool}
 */
export const doObjectsCollide = (a, b, tolerance) => {
